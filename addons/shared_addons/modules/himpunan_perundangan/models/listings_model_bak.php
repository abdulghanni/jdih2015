...
{
	protected $_dbprefix = '';
	var $entries_table 		= 'jakarta2011.ph_entries'; 	// Entries table
	var $categories_table 	= 'jakarta2011.ph_categories'; 	// Category table
	var $sub_categories_table 	= 'jakarta2011.ph_subcategories'; 	// Category table
	/**
	 * Constructor
	 *
	 * @access	public
	...
	function get_new_entries($limit = '5', $category = FALSE)
	{
		...
		$this->db->select($this->categories_table.'.description AS cat_description, '.$this->entries_table.'.title as title,'.$this->entries_table.'.description, entry_id, CAST(title as SIGNED) as title, regyear, hits, downloaded');
