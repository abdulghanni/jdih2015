...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
	<tr>
		...
		<td valign="top" style="padding-left:10px; padding-right:10px;">
			<form name="formSearch" action="<?=base_url()?>produkhukum/search" method="post" style="margin:0px;padding:5px 10px 5px 10px; margin-bottom:10px">
			  <table align="center" style="margin-top: 0px;">
				<tr>
				  ...
				  <td style="padding:1px 2px 2px 2px"><input name="nomor" type="text" style="width:50px;font-size:11px" /></td>
				  <td style="padding:2px 2px 2px 2px">Tahun</td>
				  <td style="padding:1px 2px 2px 2px"><input name="tahun" type="text" style="width:50px;font-size:11px" /></td>
				  <td style="padding:2px 2px 2px 2px">Tentang</td>
				  <td style="padding:1px 2px 2px 2px"><input name="tentang" type="text" style="width:150px;font-size:11px" /></td>
			...
			<TABLE width="100%" style="margin-bottom: 10px">
				<tr>
				<td align="left" valign="bottom" nowrap="nowrap"><span class="section-title"><?=$entries['category']?></span></td>
				<td valign="bottom" class="section-middle" width="100%">&nbsp;</td>
				</tr>
			</table>
			<table width="100%" border="0" cellspacing="1" cellpadding="0">
			...
			<tr><td colspan="2" style="height: 9px; background: transparent url(<?php echo base_url(); ?>/application/modules/produkhukum/views/images/dot.gif) top left repeat-x"></td></tr>
			...
			?>
			<tr>
				<td style="padding: 1px 5px 2px 5px">Belum ada produk hukum dalam kategori ini</td>
			</tr>
			<?php
				endif;
			?>
