...
<?= form_open('admin/produkhukum/action');?>
	<table border="0" class="listTable" style="padding:2px">    
		...
		<tr>
			...
			<td nowrap="nowrap" valign="top"><?=$entry->c_description?> No. <?=$entry->title?> Tahun <?=$entry->regyear?></td>
			...
			<td style="text-align:center" valign="top">
                ...
                <?= anchor('admin/produkhukum/delete/' . $entry->entry_id, lang('produkhukum_delete_label'), array('class'=>'confirm')); ?>
