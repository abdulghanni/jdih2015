<div id="upload-box">
	<h2><?php echo lang('files.upload.title'); ?><span class="close ui-icon ui-icon-closethick">Close</span></h2>
		<?php echo form_open_multipart('admin/banner/upload'); ?>
...
<div id="files_browser">
        ...
        <h3><?php echo lang('files.folders.label'); ?></h3>
            <ul id="files-nav">
                ...
                <li id="folder-id-<?php echo $folder->id; ?>" class="<?php echo $key == 0 ? 'current' : ''; ?>">
                    <?php echo anchor("index.php/banner/admin_image/index/{$folder->id}/?id=".$field_id."&name=".$field_name."&type=".$field_type."&form_field_id=".$form_field_id."&form_field_name=".$form_field_name, $folder->name, 'title="'.$folder->slug.'"'); ?>
                </li>
                ...
                <li class="upload">
                    <?php echo anchor("index.php/banner/admin_image/?id=".$field_id."&name=".$field_name."&form_field_id=".$form_field_id."&form_field_name=".$form_field_name."&type=".$field_type."#upload", lang('files.upload.title'), 'title="upload"'); ?>
                </li>
				<?php endif; ?>
    ...
    <div id="files_right_pane">
        ...
        <div style="display:block;height:400px;overflow:auto">
        <table class="table-list" border="0">
            ...
            <tbody>
                ...
                <tr class="<?php echo alternator('', 'alt'); ?>">
                    <td class="image"><img class="pyro-image" src="<?php echo base_url(); ?>uploads/files/<?php echo $file->filename; ?>" alt="<?php echo $file->name; ?>" width="50" onclick="javascript:insertImage('<?php echo $form_field_name; ?>', '<?php echo $file->filename; ?>', '<?php echo $form_field_id; ?>', '<?php echo htmlentities($file->id); ?>');" style="cursor:pointer" /></td>
