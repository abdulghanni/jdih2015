...
{
	protected $_dbprefix = '';
	var $entries_table 		= 'produkhukum.ph_entries'; 	// Entries table
	var $categories_table 	= 'produkhukum.ph_categories'; 	// Category table
	var $sub_categories_table 	= 'produkhukum.ph_subcategories'; 	// Category table
	/**
	 * Constructor
	 *
	 * @access	public
