...
class Theme_Bh2013 extends Theme {

    public $name			= 'Biro Hukum 2013 Theme';
    public $author			= 'Pandawa';
    public $author_website	= 'http://pandawa.com/';
    public $website			= 'http://pandawa.com/';
    public $description		= 'Biro Hukum Theme Version 2013 - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
	...
	public function __construct()
	{
		...
		Settings::temp('theme_bh2013', compact('cufon_enabled', 'cufon_font'));
	}
}
