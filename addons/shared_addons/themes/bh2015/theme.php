...
class Theme_Bh2015 extends Theme {

    public $name			= 'Biro Hukum 2015 Theme';
    public $author			= 'Pandawa';
    public $author_website	= 'http://pandawa.com/';
    public $website			= 'http://pandawa.com/';
    public $description		= 'Biro Hukum Theme Version 2015 - 2 Column, Fixed width, Horizontal navigation, CSS3 styling.';
	...
	public function __construct()
	{
		...
		Settings::temp('theme_bh2015', compact('cufon_enabled', 'cufon_font'));
	}
}
